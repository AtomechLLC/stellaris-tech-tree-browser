...
- [x] 01-04-PLAN.md — Icon pipeline (DDS→WebP conversion + resolution + placeholder fallback)
...
- [x] 04-06-PLAN.md — Save outcome flow: designs + archive output construction, confirmations, downloads, in-place write with pre-write backup, result banners (D-02, D-04, D-05, D-08)
